...
class Cell:
    ...
    def __sub__(self, other):
        ...
        raise ValueError('Разность ячеек меньше или равна 0')
    ...
    def make_order(self, cells_in_lines: int):
        ...
        tmp = self.cell_count // cells_in_lines
        tmp2 = self.cell_count % cells_in_lines
        result = '\n'.join(['*' * tmp2 if idx + 1 == tmp and tmp2
                            else '*' * cells_in_lines
